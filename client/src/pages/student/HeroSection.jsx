...
const HeroSection = () => {
  return (
    <div
     ...
     bg-gradient-to-r from-blue-500 to bg-indigo-600 dark:from-gray-800 dark:to-gray-900 py-24 px-4 text-center"
    >
      <div className="max-w-3xl">
        ...
        >
          ...
          />
          <Button className="bg-blue-600 dark:bg-gray-700 text-white px-6 py-3 rounded-r-full hover:bg-blue-700 dark:hover:bg-blue-700">
            Search
          </Button>
        </form>
